...
using AutomationFramework4.BaseClass;
using AutomationFramework4.Configuration;
using AutomationFramework4.Settings;
...
namespace AutomationFramework4.TestScripts
{
    ...
    public class Testeconomictimes :BaseClasses

    {
        ...
        public Testeconomictimes() : base(BrowserType.Firefox)
        {
        ...
        [Test]
        public void Verifyeconomictimes()
        {
            ...
            //Console.WriteLine("Url : {0}", config.GetUrl());
            ...
            //  < add key = "Url" value = "https://economictimes.indiatimes.com/" />
            ...
            // ObjectRepository.Driver.Navigate().GoToUrl(ObjectRepository.Config.GetUrlone());
            ...
            //  BaseClasses.test = BaseClasses.extent.StartTest("Verifyeconomictimes");
        ...
        [Test]
        public void Verifyeconomictimesnew()
        {
