...
namespace AutomationFramework4.TestScripts
{
...

    {
        ...
        public Testzeetv() :base (BrowserType.Firefox)
        {
        ...
        [Test]
        public void Verifyzeetv()
        {




            //  ObjectRepository.Driver.Navigate().GoToUrl(ObjectRepository.Config.GetUrlfour());
           ...
           // BaseClasses.test = BaseClasses.extent.StartTest("Verifyzeetv");
